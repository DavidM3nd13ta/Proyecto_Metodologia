	...
	<table border>
		...
		<tbody>
			<tr>
				...
				<td><a class="actualizar" href="actualizar_usuario.php?Cedula=<?php echo $mostrardatos['Cedula'];?>">Actualizar</a></td>
				<td><a class="eliminar" href="eliminar_usuario.php?Cedula=<?php echo $mostrardatos['Cedula'];?>">Eliminar</a></td>
			</tr>
		</tbody>				
		<?php }?>
	</table>
