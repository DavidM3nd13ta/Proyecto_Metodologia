<?php
    ...
    $consultarDatos="SELECT*FROM cliente WHERE Cedula='$cedula'";
    $resultadoConsulta=mysqli_query($conexion, $consultarDatos);
    $consultaDaosFilas=mysqli_num_rows($resultadoConsulta);

    if($consultaDaosFilas>0){
        $cedula=$_POST['cedula'];
        ...
        header("location: ../vista/logeo_usuario.html");
    }
